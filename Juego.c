...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        if (pantallaActual == MENU) {
            ...
            // Ejecuta la lógica de la ronda y captura si devuelve 1 (volver al menú)
            if (actualizarPartida() == 1) {
                pantallaActual = MENU;
            }
        }
        ...
        BeginDrawing();
            ...
            if (pantallaActual == MENU) {
                ...
                // Le pasamos la constante 'pantallaAncho' que requiere tu función
